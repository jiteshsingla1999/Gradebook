...
namespace GradeBook
{
    public class Book2 : CourseStructure
    {
        /// <summary>
        /// Key Value Pair<Student Name, Score> </Student>
        /// </summary>
        public List<KeyValuePair<string, PracticalMarks>> grades { get; set; }
        ...
        public Book2(string name = "NotGiven", List<KeyValuePair<string, PracticalMarks>> grades = null)
        {
            this.CourseName = name;
            grades = new List<KeyValuePair<string, PracticalMarks>>();
            count = 0;
        ...
        public void add(string studentID, int internalAssmt = 0, int midAssmt = 0, int endAssmt = 0, int internalPracMarks = 0, int externalPracMarks = 0)
        {
            ...
            PracticalMarks score = new PracticalMarks(internalAssmt, midAssmt, endAssmt, internalPracMarks, externalPracMarks);
            ...
            grades.Add(new KeyValuePair<string, PracticalMarks>(studentID, score));
            count += 1;
            updateStats();
            return;
        }
        ...
        public void DisplayGrads()
        {
            ...
            foreach (var i in grades)
            {
                ...
                Console.WriteLine($"{i.Value.getGrade(gradeGuide)}".PadRight(20));
            }
        }
